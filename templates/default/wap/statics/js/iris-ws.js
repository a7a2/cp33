...
<!--
var uvData = new Object(); 
uvData.platform = platform; 
uvData.username = username; 
uvData.enclientpasswd= enclientpasswd; 
var uvDataJson = JSON.stringify(uvData);
-->
var host = window.location.host; 
var uvData="platform="+platform+"&username="+username+"&enclientpasswd="+enclientpasswd;
var Ws = (function () {
    //
