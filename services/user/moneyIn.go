...
func PostMoneyIn(uid *int, pmi *models.PostMoneyIn) (result models.Result) {
	...
	tD, _ := time.ParseInLocation("2006-01-02 15:04:05", time.Now().Add(-time.Minute*10).String(), time.Local)
	var mi models.MoneyIn
	...
	//models.Db.Delete(&mi)
	result = models.Result{Code: 200, Message: "登陆你的支付账号进行支付", Data: &mi}
	return
}
